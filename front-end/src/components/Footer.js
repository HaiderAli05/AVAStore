        ...
        <footer className="bg-secondary text-light text-center text-lg-start">
            <div className="container py-5">
                ...
                <div className="col-lg-6 col-md-12 mb-4 mb-md-0">
                    <h5 className="text-uppercase display-6 text-white">AVA STORE</h5>
                    <p className="lead">
                ...
                <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
                    ...
                    <li>
                        <Link to="/products" className="text-light text-decoration-none d-inline-block my-1">Products</Link>
                    </li>
                    <li>
                        <Link to="/login" className="text-light text-decoration-none d-inline-block my-1">LogIn</Link>
                    </li>
                    <li>
                        <Link to="/register" className="text-light text-decoration-none d-inline-block my-1">Register</Link>
                    </li>
                    </ul>
                </div>
                <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
                    ...
                    <li>
                        <Link mailto="abc@xyz.com" to="/" className="text-light text-decoration-none d-inline-block my-1">abc@xyz.com</Link>
                    </li>
                    <li>
                        <Link to="/" className="text-light text-decoration-none d-inline-block my-1">Address of Ava Store.</Link>
                    </li>
                    </ul>
                </div>
                </div>
